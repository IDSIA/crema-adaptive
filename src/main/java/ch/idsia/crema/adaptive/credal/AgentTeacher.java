...
import ch.idsia.crema.adaptive.credal.scoring.ScoringFunction;
import ch.idsia.crema.adaptive.credal.stopping.StoppingCondition;
 ...
 */
class AgentTeacher<F extends GenericFactor> {
